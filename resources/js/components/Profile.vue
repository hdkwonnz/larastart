        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <div class="widget-user-image">
                  <img class="img-circle" :src="getProfilePhoto()" :alt="this.form.name">
                </div>
            ...
            <ul class="nav nav-tabs">
              <li class=""><a class="btn btn-lg btn-default" href="#activity" data-toggle="tab" aria-expanded="false">Activity</a></li>
              <li><a class="btn btn-lg btn-default" href="#timeline" data-toggle="tab">Timeline</a></li>
              <li class="active"><a class="btn btn-lg btn-default" href="#settings" data-toggle="tab" aria-expanded="true">Settings</a></li>
            </ul>
                ...
                <form class="form-horizontal">
                  ...
                  <div class="form-group"> 
                    <label for="password" class="col-sm-12 control-label">
                      Password(leave empty if not change
                    </label>
...
<script>
    export default {
        ...
        methods: {
          getProfilePhoto(){
              ////return "img/profile/"+this.form.photo;////not working...
