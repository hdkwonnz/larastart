        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/dashboard" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt color_blue"></i>
              <p>
                Dashboard               
              </p>
            </router-link>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">              
              <i class="nav-icon fas fa-cog color_green"></i>
              <p>
                Management
          ...
          <li class="nav-item">
            <router-link to="/profile" class="nav-link">
              <i class="nav-icon fas fa-user color_orange"></i>
              <p>
                Profile             
              </p>
            </router-link>
          ...
          <li class="nav-item">           
            <a class="nav-link" href="{{ route('logout') }}"
                 onclick="event.preventDefault();
                  ...
                  <i class="nav-icon fas fa-power-off color_red"></i> 
                  <p>
                    {{ __('Logout') }}
                  </p>                              
            </a>
